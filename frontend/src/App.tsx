...
const Spinner = () => <Box sx={{ display: 'flex', justifyContent: 'center', mt: 10 }}><CircularProgress /></Box>;
  ...
  return (
    <Suspense fallback={<Spinner />}>
      <Routes>
        ...
        <Route path="/resources/:resourceId/edit" element={<ProtectedRoute><TextEditorPage /></ProtectedRoute>} />
