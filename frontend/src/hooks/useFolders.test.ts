...
import { useFolderChildren, useFolder, useTrash, useRestoreFolder, usePurgeFolder } from './useFolders';
...
const mockFolder = { id: 1, name: 'Docs', parentId: null, path: '/1/', description: null, trashed: false, trashedAt: null, createdBy: 1, createdAt: '', updatedAt: '' };
