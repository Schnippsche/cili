...
import {
  Alert, Box, CircularProgress, Container, InputAdornment,
  Pagination, TextField, ToggleButton, ToggleButtonGroup, Typography,
} from '@mui/material';
...
export default function PublicTestimonialsPage() {
  ...
  return (
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      {error && <Alert severity="error" sx={{ mt: 2 }}>Erfahrungsberichte konnten nicht geladen werden.</Alert>}
