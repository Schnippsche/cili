...
import {
  useCollection, useCollectionItems, useRemoveFromCollection,
  useCollectionTestimonials, useRemoveTestimonialFromCollection,
      ...
      <Box sx={{ p: 3 }}>
        ...
        {!isLoading && resources.length === 0 && testimonials.length === 0 && (
          <Typography color="text.secondary">
            Diese Sammlung ist leer. Füge Ressourcen oder Erfahrungsberichte über das Kontextmenü hinzu.
          </Typography>
        )}
