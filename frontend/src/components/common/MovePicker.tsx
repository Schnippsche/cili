...
function FolderNode({ folderId, name, selectedId, excludeId, onSelect, depth }: Readonly<FolderNodeProps>) {
    ...
    <>
      ...
      >
        ...
        <ListItemIcon sx={{ minWidth: 32 }}>
          {isSelected ? <FolderOpenIcon fontSize="small" color="primary" /> : <FolderIcon fontSize="small" />}
        </ListItemIcon>
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="xs" fullWidth>
      ...
      <DialogActions>
        ...
        <Button variant="contained" disabled={selectedId == null || pending} onClick={handleConfirm}>
          Verschieben
        </Button>
      </DialogActions>
    </Dialog>
