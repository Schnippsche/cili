...
interface Props { open: boolean; isMobile: boolean; onClose: () => void; }
...
export default function Sidebar({ open, isMobile, onClose }: Readonly<Props>) {
  ...
  const paperWidth = isMobile ? WIDTH : (open ? WIDTH : MINI);
        ...
        <List dense>
          ...
          {canViewTestimonials && (
            <Tooltip title={open ? '' : 'Erfahrungsberichte'} placement="right">
              <ListItemButton component={NavLink as ElementType} to="/testimonials" {...navClick}>
          ...
          {user?.role === 'ADMIN' && (
            <>
              ...
              <Tooltip title={open ? '' : 'Benutzer'} placement="right">
                <ListItemButton component={NavLink as ElementType} to="/admin/users" {...navClick}>
              ...
              <Tooltip title={open ? '' : 'Gruppen & Rechte'} placement="right">
                <ListItemButton component={NavLink as ElementType} to="/admin/groups" {...navClick}>
              ...
              <Tooltip title={open ? '' : 'Jobs'} placement="right">
                <ListItemButton component={NavLink as ElementType} to="/admin/jobs" {...navClick}>
              ...
              <Tooltip title={open ? '' : 'Server-Log'} placement="right">
                <ListItemButton component={NavLink as ElementType} to="/admin/logs" {...navClick}>
              ...
              <Tooltip title={open ? '' : 'Bulk-Ordner-Import'} placement="right">
                <ListItemButton component={NavLink as ElementType} to="/admin/bulk-import" {...navClick}>
                  <ListItemIcon sx={{ minWidth: 40 }}><DriveFolderUploadOutlinedIcon /></ListItemIcon>
