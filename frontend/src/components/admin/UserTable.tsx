        ...
        <DialogContent>
          <Box sx={{display: 'flex', gap: 1, mb: 2}}>
            <Autocomplete
                ...
                renderInput={params => <TextField {...params} label="Gruppe hinzufügen"
                                                  size="small"/>}
            />
...
function DeleteConfirmDialog({user, onConfirm, onClose}: Readonly<{
  user: UserDto;
  onConfirm: () => void;
  onClose: () => void
}>) {
  ...
  return (
      <Dialog open onClose={onClose} maxWidth="xs" fullWidth fullScreen={isMobile}>
        ...
        <DialogContent>
          Soll der Benutzer <strong>{user.username}</strong> wirklich gelöscht werden? Diese Aktion
      ...
      <Dialog open onClose={onClose} maxWidth="xs" fullWidth fullScreen={isMobile}>
        ...
        <DialogContent sx={{display: 'flex', flexDirection: 'column', gap: 2, mt: 1}}>
          ...
          <TextField
              ...
              onChange={e => setForm({
                ...form,
                memberId: e.target.value === '' ? undefined : Number(e.target.value)
              })}
          />
          <TextField
      ...
      <>
          ...
          <Table size="small">
            <TableHead>
              <TableRow>
                ...
                <TableCell>Rolle</TableCell><TableCell>Status</TableCell><TableCell
                  align="right">Aktionen</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              ...
              {data?.content.map(u => (
                  <TableRow key={u.id} hover>
                    ...
                    <TableCell><Chip label={u.active ? 'Aktiv' : 'Inaktiv'}
                    ...
                    <TableCell align="right">
                      ...
                      <Tooltip
                          title="Etikettenbogen (Zweckform 6174) mit QR-Code erzeugen und anzeigen">
                    <span>
                      <IconButton
                          size="small"
        ...
        <Dialog open={createOpen} onClose={handleClose} maxWidth="xs" fullWidth
          ...
          <DialogContent sx={{display: 'flex', flexDirection: 'column', gap: 2, mt: 1}}>
            ...
            <TextField label="Benutzername" value={form.username}
            ...
            <FormControl fullWidth>
              <InputLabel>Rolle</InputLabel>
              <Select value={form.role} label="Rolle"
                      onChange={e => setForm({...form, role: e.target.value})}>
                <MenuItem value="USER">USER</MenuItem>
                <MenuItem value="ADMIN">ADMIN</MenuItem>
              </Select>
