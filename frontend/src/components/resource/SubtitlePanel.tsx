...
export default function SubtitlePanel({resource, open, onClose}: Readonly<Props>) {
  ...
  return (
      <Drawer anchor="right" open={open} onClose={onClose}
        ...
        <SubtitleSection resourceId={resource.id} readonly={!canManageSubtitles}
                         canDownload={canDownload}/>
        <TranslationSection resourceId={resource.id} canTranslateSubtitles={canTranslateSubtitles}
                            readonly={!canTranslateSubtitles}/>
