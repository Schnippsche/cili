...
import {addTestimonialToCollection, addToCollection} from '../../api/collections';
...
export default function BulkAddToCollectionDialog({
                                                    open,
                                                    resourceIds,
                                                    testimonialIds,
                                                    onClose,
      ...
      <Dialog open={open} onClose={loading ? undefined : handleClose} maxWidth="xs" fullWidth>
        ...
        <DialogContent sx={{p: 0}}>
          <Typography variant="body2" color="text.secondary" sx={{px: 2, pt: 1, pb: 0.5}}>
            {total} {total === 1 ? 'Eintrag' : 'Einträge'} werden der gewählten Sammlung
            hinzugefügt.
          </Typography>
          {loading ? (
