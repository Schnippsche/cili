          ...
          <Box sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            <Stack direction="row" alignItems="center" flexWrap="wrap" gap={1}>
              ...
              <Typography variant="subtitle1"
                          fontWeight="bold">{testimonial.authorName}</Typography>
            </Stack>
            <Box sx={{flexShrink: 0, ml: 1}}>
              ...
              {showDelete && (
                  <Tooltip title="Löschen">
                    <IconButton size="small" aria-label="Löschen"
              ...
              {showAddToCollection && (
                  <Tooltip title="Zur Sammlung hinzufügen">
                    <IconButton size="small" aria-label="Zur Sammlung hinzufügen"
                                onClick={() => setCollectionOpen(true)}>
                      <BookmarkAddOutlinedIcon fontSize="small"/>
                    </IconButton>
                  </Tooltip>
              )}
              <Tooltip title="Öffentlichen Link generieren">
                <IconButton size="small" aria-label="Öffentlichen Link generieren"
              ...
              {onRemoveFromCollection && (
                  <Tooltip title="Aus Sammlung entfernen">
                    <IconButton size="small" aria-label="Aus Sammlung entfernen"
                                onClick={() => onRemoveFromCollection(testimonial.id)}>
