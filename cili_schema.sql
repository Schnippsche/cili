...
(
    `id`            bigint                                                                                                                                                                                                                                                             NOT NULL AUTO_INCREMENT,
    `resource_id`   bigint                                                                                                                                                                                                                                                                      DEFAULT NULL,
    `type`          enum ('THUMBNAIL','OCR','PREVIEW','TRANSCODE','VIDEO_ANALYSIS','VIDEO_TRANSCODE','WAV_EXTRACT','WHISPER_TRANSCRIBE','AUDIO_NORMALIZE','SUBTITLE_TRANSLATE','DOCUMENT_TRANSLATE','OLLAMA_ANALYSIS','TELEGRAM_IMPORT','VIDEO_URL_IMPORT','VIDEO_CLIP') COLLATE utf8mb4_unicode_ci NOT NULL,
